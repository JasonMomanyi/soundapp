...
export function createTransport() {
    ...
    el.className = 'transport-bar flex items-center gap-4 px-6 py-3 z-30';
    ...
    <div class="flex items-center gap-3 ml-2">
      <div class="flex flex-col items-center">
        ...
        <div class="flex items-center gap-1">
          ...
          <input id="bpm-input" type="number" min="40" max="240" value="120"
            class="font-mono text-center font-bold focus:outline-none rounded-md px-2 py-1"
      ...
      <button id="tap-btn" class="btn-neon" style="font-size:0.65rem; padding:6px 10px" title="Tap for BPM">TAP</button>
    </div>

    <!-- Separator -->
    <div style="width:1px; height:36px; background:rgba(255,255,255,0.06)" class="mx-1"></div>
    ...
    <div class="flex flex-col items-center" style="min-width: 120px">
      ...
      <input id="master-vol" type="range" min="0" max="100" value="80" style="width:110px"/>
    </div>
